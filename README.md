...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `lxd` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-lxd_darwin_amd64_v1
│   └── pulumi-resource-lxd
├── pulumi-lxd_darwin_arm64
│   └── pulumi-resource-lxd
├── pulumi-lxd_linux_amd64_v1
│   └── pulumi-resource-lxd
├── pulumi-lxd_linux_arm64
│   └── pulumi-resource-lxd
├── pulumi-lxd_windows_amd64_v1
│   └── pulumi-resource-lxd.exe
└── pulumi-lxd_windows_arm64
    └── pulumi-resource-lxd.exe
```
